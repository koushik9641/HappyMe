...
public class GameManager : Singleton<GameManager>
{
...
#endif
        /*RewardAd.Instance.LoadRewardAd();
        Ad.Instance.RequestBanner();
        Debug.Log("RequestBanner..................111111111111");*/

        //AdsManager.Instance.LoadBanner();

        if (!PlayerPrefs.HasKey("hintNum"))
        {
            PlayerPrefs.SetInt("hintNum", 150);
        }
        HintNumTxt.text = PlayerPrefs.GetInt("hintNum", 150).ToString();
    ...
    public void showHintBoard()
    {
        ...
        {
            if (PlayerPrefs.GetInt("hintNum", 150) == 0)
                UseHint.interactable = false;
            if (PlayerPrefs.GetInt("totalStar", 0) < 50)
    ...
    public void GetHintPanelClose()
    {
        getHintPanel.SetActive(false);
    }
    ...
    {
        if (PlayerPrefs.GetInt("hintNum") > 0) 
        {
            Debug.Log(PlayerPrefs.GetInt("hintNum") + "Hint hain ......");
            PlayerPrefs.SetInt("hintNum", PlayerPrefs.GetInt("hintNum", 150) - 50);
            HintNumTxt.text = PlayerPrefs.GetInt("hintNum", 150).ToString();
            UseHint.interactable = false;
            showHint = true;
            Time.timeScale = 1;
        ...
        else
        {
            ...
            //MyRewardManager.Instance.RequestRewardVideo();
        }
        
    }

    public void PanelShopClose()
    {
    ...
    public void BuyHintClick()
    {
        if (PlayerPrefs.GetInt("totalStar", 0) >= 50)
        {
            PlayerPrefs.SetInt("hintNum", PlayerPrefs.GetInt("hintNum", 150) + 1);
            PlayerPrefs.SetInt("totalStar", PlayerPrefs.GetInt("totalStar", 0) - 50);
            if (PlayerPrefs.GetInt("totalStar", 0) < 50)
                BuyHint.interactable = false;
            txtTotalStar.text = PlayerPrefs.GetInt("totalStar", 0).ToString();
            HintNumTxt.text = PlayerPrefs.GetInt("hintNum", 150).ToString();
    ...
    IEnumerator VictoryIEnumerator()
    {
        ...
        if (PlayerPrefs.GetInt("curLevel", 1) == PlayerPrefs.GetInt("LevelOpen", 1))
            PlayerPrefs.SetInt("LevelOpen", PlayerPrefs.GetInt("LevelOpen", 1) + 1); //open lv
        if (starSlider.starNum > PlayerPrefs.GetInt("star_lv" + PlayerPrefs.GetInt("curLevel", 1), 0))
        {
            ...
            txtTotalStar.text = PlayerPrefs.GetInt("totalStar", 0).ToString();
            PlayerPrefs.SetInt("star_lv" + PlayerPrefs.GetInt("curLevel", 1), starSlider.starNum); //save star
            if (PlayerPrefs.GetInt("countForGift", 0) < 2)
        ...
        Debug.Log("winnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn");
        //  GetComponentInChildren<LevelInfo>().ShowAnimTree();
